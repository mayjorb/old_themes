...
if (theme_get_setting('color_enable_schemes') == 'on') {
  drupal_add_css(drupal_get_path('theme', 'coresurfnetwork') .'/css/theme/'. get_at_colors(), 'theme');
}
 ...
 */
/*
function coresurfnetwork_preprocess(&$vars, $hook) {
 ...
 */
/*
function coresurfnetwork_preprocess_page(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
*/
 ...
 */
/*
function coresurfnetwork_preprocess_node(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
*/
 ...
 */
/*
function coresurfnetwork_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
*/
 ...
 */
/*
function coresurfnetwork_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
*/
